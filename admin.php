    ...
    <div class="my-auto upload-container">
        <form action="includes/gallery-helper.php" method="POST" enctype="multipart/form-data">
            <div class="form-group">
                <img src="Images/avatar-1577909_1280.png" onclick="triggered()" id="gallery-display">
            ...
            <div class="form-group">
                <button type="submit" name="galery-submit" class="btn btn-outline-success btn-lg btn-block">Upload</button>
            </div>
        </form>
    </div>
</div>
